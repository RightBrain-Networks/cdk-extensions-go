...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addPrivatePool", GoMethod: "AddPrivatePool"},
			_jsii_.MemberMethod{JsiiMethod: "addRegion", GoMethod: "AddRegion"},
			_jsii_.MemberMethod{JsiiMethod: "addStagePool", GoMethod: "AddStagePool"},
			_jsii_.MemberMethod{JsiiMethod: "allocatePrivateNetwork", GoMethod: "AllocatePrivateNetwork"},
