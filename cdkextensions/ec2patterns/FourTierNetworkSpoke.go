...
func (j *jsiiProxy_FourTierNetworkSpoke) DefaultInstanceTenancy() awsec2.DefaultInstanceTenancy {
...
func (j *jsiiProxy_FourTierNetworkSpoke) DnsHostnamesEnabled() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"dnsHostnamesEnabled",
...
func (j *jsiiProxy_FourTierNetworkSpoke) DnsSupportEnabled() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"dnsSupportEnabled",
...
func (j *jsiiProxy_FourTierNetworkSpoke) EnableDnsHostnames() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"enableDnsHostnames",
...
func (j *jsiiProxy_FourTierNetworkSpoke) EnableDnsSupport() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"enableDnsSupport",
...
func (j *jsiiProxy_FourTierNetworkSpoke) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_FourTierNetworkSpoke) IncompleteSubnetDefinition() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetworkSpoke) InternetConnectivityEstablished() constructs.IDependable {
...
func (j *jsiiProxy_FourTierNetworkSpoke) InternetGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"internetGatewayId",
...
func (j *jsiiProxy_FourTierNetworkSpoke) IpamPool() ec2.IIpamPool {
...
func (j *jsiiProxy_FourTierNetworkSpoke) IsolatedSubnets() *[]awsec2.ISubnet {
...
func (j *jsiiProxy_FourTierNetworkSpoke) MaxAzs() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxAzs",
...
func (j *jsiiProxy_FourTierNetworkSpoke) Netmask() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"netmask",
...
func (j *jsiiProxy_FourTierNetworkSpoke) Node() constructs.Node {
...
func (j *jsiiProxy_FourTierNetworkSpoke) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_FourTierNetworkSpoke) PrivateSubnets() *[]awsec2.ISubnet {
	var returns *[]awsec2.ISubnet
	_jsii_.Get(
		j,
		"privateSubnets",
...
func (j *jsiiProxy_FourTierNetworkSpoke) PublicSubnets() *[]awsec2.ISubnet {
	var returns *[]awsec2.ISubnet
	_jsii_.Get(
		j,
		"publicSubnets",
...
func (j *jsiiProxy_FourTierNetworkSpoke) Stack() awscdk.Stack {
...
func (j *jsiiProxy_FourTierNetworkSpoke) TransitGateway() ec2.ITransitGateway {
...
func (j *jsiiProxy_FourTierNetworkSpoke) TransitGatewayAttachment() ec2.ITransitGatewayAttachment {
	var returns ec2.ITransitGatewayAttachment
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcArn",
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcCidrBlock() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcCidrBlock",
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcCidrBlockAssociations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcDefaultNetworkAcl() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcDefaultSecurityGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcId",
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcIpv6CidrBlocks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"vpcIpv6CidrBlocks",
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpcName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcName",
...
func (j *jsiiProxy_FourTierNetworkSpoke) VpnGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpnGatewayId",
...
func NewFourTierNetworkSpoke(scope constructs.IConstruct, id *string, props *FourTierNetworkSpokeProps) FourTierNetworkSpoke {
	...
	if err := validateNewFourTierNetworkSpokeParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_FourTierNetworkSpoke)SetIncompleteSubnetDefinition(val *bool) {
...
func FourTierNetworkSpoke_FromLookup(scope constructs.Construct, id *string, options *awsec2.VpcLookupOptions) awsec2.IVpc {
	...
	if err := validateFourTierNetworkSpoke_FromLookupParameters(scope, id, options); err != nil {
		panic(err)
	}
...
func FourTierNetworkSpoke_FromVpcAttributes(scope constructs.Construct, id *string, attrs *awsec2.VpcAttributes) awsec2.IVpc {
	...
	if err := validateFourTierNetworkSpoke_FromVpcAttributesParameters(scope, id, attrs); err != nil {
		panic(err)
	}
	var returns awsec2.IVpc
...
func FourTierNetworkSpoke_IsConstruct(x interface{}) *bool {
	...
	if err := validateFourTierNetworkSpoke_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func FourTierNetworkSpoke_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateFourTierNetworkSpoke_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func FourTierNetworkSpoke_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateFourTierNetworkSpoke_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (f *jsiiProxy_FourTierNetworkSpoke) AddFlowLog(id *string, options *awsec2.FlowLogOptions) awsec2.FlowLog {
...
func (f *jsiiProxy_FourTierNetworkSpoke) AddGatewayEndpoint(id *string, options *awsec2.GatewayVpcEndpointOptions) awsec2.GatewayVpcEndpoint {
...
func (f *jsiiProxy_FourTierNetworkSpoke) AddInterfaceEndpoint(id *string, options *awsec2.InterfaceVpcEndpointOptions) awsec2.InterfaceVpcEndpoint {
...
func (f *jsiiProxy_FourTierNetworkSpoke) AddVpcFlowLog(id *string, options *FlowLogOptions) awsec2.FlowLog {
...
func (f *jsiiProxy_FourTierNetworkSpoke) AddVpnConnection(id *string, options *awsec2.VpnConnectionOptions) awsec2.VpnConnection {
...
func (f *jsiiProxy_FourTierNetworkSpoke) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (f *jsiiProxy_FourTierNetworkSpoke) EnableVpnGateway(options *awsec2.EnableVpnGatewayOptions) {
...
func (f *jsiiProxy_FourTierNetworkSpoke) GeneratePhysicalName() *string {
	var returns *string
...
func (f *jsiiProxy_FourTierNetworkSpoke) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (f *jsiiProxy_FourTierNetworkSpoke) GetResourceNameAttribute(nameAttr *string) *string {
...
func (f *jsiiProxy_FourTierNetworkSpoke) SelectSubnetObjects(selection *awsec2.SubnetSelection) *[]awsec2.ISubnet {
...
func (f *jsiiProxy_FourTierNetworkSpoke) SelectSubnets(selection *awsec2.SubnetSelection) *awsec2.SelectedSubnets {
...
func (f *jsiiProxy_FourTierNetworkSpoke) ToString() *string {
	var returns *string
