...
// The jsii proxy struct for FourTierNetwork
type jsiiProxy_FourTierNetwork struct {
	internal.Type__awsec2Vpc
}

func (j *jsiiProxy_FourTierNetwork) AddressManager() IpAddressManager {
...
func (j *jsiiProxy_FourTierNetwork) AvailabilityZones() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"availabilityZones",
...
func (j *jsiiProxy_FourTierNetwork) DefaultInstanceTenancy() awsec2.DefaultInstanceTenancy {
...
func (j *jsiiProxy_FourTierNetwork) DnsHostnamesEnabled() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"dnsHostnamesEnabled",
...
func (j *jsiiProxy_FourTierNetwork) DnsSupportEnabled() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"dnsSupportEnabled",
...
func (j *jsiiProxy_FourTierNetwork) EnableDnsHostnames() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"enableDnsHostnames",
...
func (j *jsiiProxy_FourTierNetwork) EnableDnsSupport() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"enableDnsSupport",
...
func (j *jsiiProxy_FourTierNetwork) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_FourTierNetwork) IncompleteSubnetDefinition() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetwork) InternetConnectivityEstablished() constructs.IDependable {
...
func (j *jsiiProxy_FourTierNetwork) InternetGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"internetGatewayId",
...
func (j *jsiiProxy_FourTierNetwork) IpamPool() ec2.IIpamPool {
...
func (j *jsiiProxy_FourTierNetwork) IsolatedSubnets() *[]awsec2.ISubnet {
...
func (j *jsiiProxy_FourTierNetwork) MaxAzs() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxAzs",
...
func (j *jsiiProxy_FourTierNetwork) Netmask() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"netmask",
...
func (j *jsiiProxy_FourTierNetwork) Node() constructs.Node {
...
func (j *jsiiProxy_FourTierNetwork) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_FourTierNetwork) PrivateSubnets() *[]awsec2.ISubnet {
	var returns *[]awsec2.ISubnet
	_jsii_.Get(
		j,
		"privateSubnets",
...
func (j *jsiiProxy_FourTierNetwork) PublicSubnets() *[]awsec2.ISubnet {
	var returns *[]awsec2.ISubnet
	_jsii_.Get(
		j,
		"publicSubnets",
...
func (j *jsiiProxy_FourTierNetwork) Stack() awscdk.Stack {
...
func (j *jsiiProxy_FourTierNetwork) VpcArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcArn",
...
func (j *jsiiProxy_FourTierNetwork) VpcCidrBlock() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcCidrBlock",
...
func (j *jsiiProxy_FourTierNetwork) VpcCidrBlockAssociations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetwork) VpcDefaultNetworkAcl() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetwork) VpcDefaultSecurityGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FourTierNetwork) VpcId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcId",
...
func (j *jsiiProxy_FourTierNetwork) VpcIpv6CidrBlocks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"vpcIpv6CidrBlocks",
...
func (j *jsiiProxy_FourTierNetwork) VpcName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpcName",
...
func (j *jsiiProxy_FourTierNetwork) VpnGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vpnGatewayId",
...
func NewFourTierNetwork(scope constructs.IConstruct, id *string, props *FourTierNetworkProps) FourTierNetwork {
	...
	if err := validateNewFourTierNetworkParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_FourTierNetwork)SetIncompleteSubnetDefinition(val *bool) {
...
func FourTierNetwork_FromLookup(scope constructs.Construct, id *string, options *awsec2.VpcLookupOptions) awsec2.IVpc {
	...
	if err := validateFourTierNetwork_FromLookupParameters(scope, id, options); err != nil {
		panic(err)
	}
...
func FourTierNetwork_FromVpcAttributes(scope constructs.Construct, id *string, attrs *awsec2.VpcAttributes) awsec2.IVpc {
	...
	if err := validateFourTierNetwork_FromVpcAttributesParameters(scope, id, attrs); err != nil {
		panic(err)
	}
	var returns awsec2.IVpc
...
func FourTierNetwork_IsConstruct(x interface{}) *bool {
	...
	if err := validateFourTierNetwork_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func FourTierNetwork_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateFourTierNetwork_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func FourTierNetwork_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateFourTierNetwork_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (f *jsiiProxy_FourTierNetwork) AddCidrBlock(id *string, options *AddCidrBlockOptions) ec2.IVpcCidrBlock {
...
func (f *jsiiProxy_FourTierNetwork) AddClientVpnEndpoint(id *string, options *awsec2.ClientVpnEndpointOptions) awsec2.ClientVpnEndpoint {
...
func (f *jsiiProxy_FourTierNetwork) AddFlowLog(id *string, options *awsec2.FlowLogOptions) awsec2.FlowLog {
...
func (f *jsiiProxy_FourTierNetwork) AddGatewayEndpoint(id *string, options *awsec2.GatewayVpcEndpointOptions) awsec2.GatewayVpcEndpoint {
...
func (f *jsiiProxy_FourTierNetwork) AddInterfaceEndpoint(id *string, options *awsec2.InterfaceVpcEndpointOptions) awsec2.InterfaceVpcEndpoint {
...
func (f *jsiiProxy_FourTierNetwork) AddIsolatedClientVpnEndpoint(id *string, options *AddIsolatedClientVpnEndpointOptions) NetworkIsolatedClientVpnEndpoint {
...
func (f *jsiiProxy_FourTierNetwork) AddVpcFlowLog(id *string, options *FlowLogOptions) awsec2.FlowLog {
...
func (f *jsiiProxy_FourTierNetwork) AddVpnConnection(id *string, options *awsec2.VpnConnectionOptions) awsec2.VpnConnection {
...
func (f *jsiiProxy_FourTierNetwork) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (f *jsiiProxy_FourTierNetwork) EnableVpnGateway(options *awsec2.EnableVpnGatewayOptions) {
...
func (f *jsiiProxy_FourTierNetwork) GeneratePhysicalName() *string {
	var returns *string
...
func (f *jsiiProxy_FourTierNetwork) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (f *jsiiProxy_FourTierNetwork) GetResourceNameAttribute(nameAttr *string) *string {
...
func (f *jsiiProxy_FourTierNetwork) SelectSubnetObjects(selection *awsec2.SubnetSelection) *[]awsec2.ISubnet {
...
func (f *jsiiProxy_FourTierNetwork) SelectSubnets(selection *awsec2.SubnetSelection) *awsec2.SelectedSubnets {
...
func (f *jsiiProxy_FourTierNetwork) ToString() *string {
	var returns *string
