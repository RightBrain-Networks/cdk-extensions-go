...
type IpamAttributes struct {
	...
	PrivateDefaultScope IIpamScope `field:"optional" json:"privateDefaultScope" yaml:"privateDefaultScope"`
	// The IPAM's default public scope.
	PublicDefaultScope IIpamScope `field:"optional" json:"publicDefaultScope" yaml:"publicDefaultScope"`
