...
func validateTransitGatewayRoute_FromTransitGatewayRouteIdParameters(scope constructs.IConstruct, id *string, transitGatewayRouteId *string) error {
	if scope == nil {
	...
	if transitGatewayRouteId == nil {
		return fmt.Errorf("parameter transitGatewayRouteId is required, but nil was provided")
	}
