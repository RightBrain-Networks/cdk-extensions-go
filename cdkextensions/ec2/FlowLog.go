...
func (j *jsiiProxy_FlowLog) Destination() awsec2.FlowLogDestination {
	var returns awsec2.FlowLogDestination
	_jsii_.Get(
		j,
		"destination",
		&returns,
...
func (j *jsiiProxy_FlowLog) FlowLogName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"flowLogName",
...
func (j *jsiiProxy_FlowLog) LogFormat() FlowLogFormat {
...
func (j *jsiiProxy_FlowLog) MaxAggregationInterval() awsec2.FlowLogMaxAggregationInterval {
	var returns awsec2.FlowLogMaxAggregationInterval
	_jsii_.Get(
		j,
