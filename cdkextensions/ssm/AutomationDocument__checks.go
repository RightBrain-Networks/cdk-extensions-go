...
func (a *jsiiProxy_AutomationDocument) validateAddRequirementParameters(requirement *DocumentRequirement) error {
	if requirement == nil {
		return fmt.Errorf("parameter requirement is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(requirement, func() string { return "parameter requirement" }); err != nil {
		return err
	}
...
func validateAutomationDocument_FromManagedParameters(scope constructs.IConstruct, id *string, managedDocumentName *string) error {
	...
	if managedDocumentName == nil {
		return fmt.Errorf("parameter managedDocumentName is required, but nil was provided")
	}
