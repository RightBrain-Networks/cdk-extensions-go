...
// The jsii proxy struct for SecretsManagerSecretStore
type jsiiProxy_SecretsManagerSecretStore struct {
	jsiiProxy_AwsSecretStore
}

func (j *jsiiProxy_SecretsManagerSecretStore) Cluster() awseks.ICluster {
...
func (j *jsiiProxy_SecretsManagerSecretStore) Env() *awscdk.ResourceEnvironment {
...
func (j *jsiiProxy_SecretsManagerSecretStore) Manifest() awseks.KubernetesManifest {
...
func (j *jsiiProxy_SecretsManagerSecretStore) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_SecretsManagerSecretStore) Namespace() *string {
	var returns *string
	_jsii_.Get(
		j,
		"namespace",
...
func (j *jsiiProxy_SecretsManagerSecretStore) Node() constructs.Node {
...
func (j *jsiiProxy_SecretsManagerSecretStore) PhysicalName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"physicalName",
...
func (j *jsiiProxy_SecretsManagerSecretStore) SecretStoreName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"secretStoreName",
...
func (j *jsiiProxy_SecretsManagerSecretStore) Service() *string {
	var returns *string
	_jsii_.Get(
		j,
		"service",
...
func (j *jsiiProxy_SecretsManagerSecretStore) ServiceAccount() awseks.ServiceAccount {
...
func (j *jsiiProxy_SecretsManagerSecretStore) Stack() awscdk.Stack {
...
func NewSecretsManagerSecretStore(scope constructs.Construct, id *string, props *SecretsManagerSecretStoreProps) SecretsManagerSecretStore {
	...
	if err := validateNewSecretsManagerSecretStoreParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func SecretsManagerSecretStore_IsConstruct(x interface{}) *bool {
	...
	if err := validateSecretsManagerSecretStore_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SecretsManagerSecretStore_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateSecretsManagerSecretStore_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func SecretsManagerSecretStore_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateSecretsManagerSecretStore_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SecretsManagerSecretStore) AddSecret(id *string, secret awssecretsmanager.ISecret, options *ExternalSecretOptions) ExternalSecret {
	if err := s.validateAddSecretParameters(id, secret, options); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecretsManagerSecretStore) ApplyRemovalPolicy(policy awscdk.RemovalPolicy) {
...
func (s *jsiiProxy_SecretsManagerSecretStore) GeneratePhysicalName() *string {
	var returns *string
...
func (s *jsiiProxy_SecretsManagerSecretStore) GetResourceArnAttribute(arnAttr *string, arnComponents *awscdk.ArnComponents) *string {
...
func (s *jsiiProxy_SecretsManagerSecretStore) GetResourceNameAttribute(nameAttr *string) *string {
...
func (s *jsiiProxy_SecretsManagerSecretStore) ToString() *string {
	var returns *string
